...
--
-- Host: 127.0.0.1
-- Generation Time: 07-Jan-2016 às 20:56
...
CREATE TABLE `modais` (
  ...
  `id_percurso` int(11) DEFAULT NULL,
...
CREATE TABLE `percursos` (
  ...
  `codigo_aeroporto` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
--
-- Limitadores para a tabela `modais`
--
ALTER TABLE `modais`
  ADD CONSTRAINT `modais_ibfk_1` FOREIGN KEY (`id_percurso`) REFERENCES `percursos` (`id_percurso`) ON DELETE SET NULL;
