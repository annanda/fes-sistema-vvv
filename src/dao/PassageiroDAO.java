...
public class PassageiroDAO extends DAO {
    ...
    public int cadastrarPassageiro(Passageiro novo_passageiro) {
        ...
        try {
            ...
            sql_query =
                    selectFactory(tabela, new String[] { "id_passageiro" }, "cpf = "
    ...
    public ArrayList<Passageiro> listarPassageiros(HashMap<String, String> conditions) {
        ...
        try {
            ...
            while (result_set.next()) {
                ...
                passageiros_encontrados.add(new Passageiro(result_set.getInt("id_passageiro"),
                        result_set.getInt("id_pessoa"), result_set.getString("nome"), result_set
                                .getString("endereco"), result_set.getString("codigo"), result_set
                                .getString("cpf"), result_set.getString("telefone"), result_set
                                .getString("profissao"), result_set.getDate("data_de_nascimento"),
                        responsavel));
            }
        } catch (SQLException e) {
            // TODO Auto-generated catch block
