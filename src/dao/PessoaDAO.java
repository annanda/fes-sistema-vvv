...
public class PessoaDAO extends DAO {
    ...
    public int cadastrarPessoa(Pessoa nova_pessoa) {
        ...
        String sql_query =
                insertFactory(tabela,
                        new String[] { nova_pessoa.getNome(), nova_pessoa.getEndereco(), codigo });
        ...
        try {
            ...
            while (result_set.next()) {
                pessoas_encontradas.add(new Pessoa(result_set.getInt("id_pessoa"), result_set
                        .getString("nome"), result_set.getString("endereco"), result_set
                        .getString("codigo")));
            }
        } catch (SQLException e) {
            // TODO Auto-generated catch block
    ...
    public void alterarPessoa(Pessoa pessoa_modificada) {
        String sql_query =
                updateFactory(tabela, pessoa_modificada.toHashMap(), "id_pessoa = "
                        + pessoa_modificada.getId());
