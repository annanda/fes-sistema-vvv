...
public class ModalDAO extends DAO {
    ...
    String sql_query =
        insertFactory(
            ...
            new String[] {novo_modal.getTipo(), codigo, novo_modal.getCompanhia(),
                ...
                "" + novo_modal.getAnoFabricacao(), "" + novo_modal.getEmManutencao(),
                "" + novo_modal.getEmUso(),
  ...
  public ArrayList<Modal> listarModais(HashMap<String, String> conditions) {
    ...
    try {
      ...
      while (result_set.next()) {
        ...
        modais_encontrados.add(new Modal(id_modal, PercursoController.getPercursoByModal(id_modal),
            result_set.getString("tipo"), result_set.getString("codigo"), result_set
  ...
  public Modal getModalById(int id) {
    ...
    String sql_query = selectFactory(tabela, new String[] {Constants.ASTERISK}, "id_modal = " + id);
    ...
    try {
      ...
      if (result_set.first()) {
        modal_encontrado =
            new Modal(id, PercursoController.getPercursoByModal(id), result_set.getString("tipo"),
