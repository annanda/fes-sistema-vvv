...
public class TestPassageiro {
  ...
  public void cadastrarPassageiroComResponsavel() {
    ...
    try {
      ...
      id =
          PassageiroController.cadastrarPassageiro("asdf", "asdf", "asdf", "asdf", "asdf", "asdf",
              date, Integer.toString(id_responsavel));
    } catch (Exception e) {
      fail();
    } finally {
      if (id > 0) {
  ...
  public void listarPassageiros() {
    PassageiroController.cadastrarPassageiro("test", "test", "test", "test", "test", "test", date,
        null);
    ArrayList<Passageiro> l = PassageiroController.listarPassageiros("test", "test", "test", date);
    Pessoa p = pessoa_dao.getPessoaByCodigo("test");
    PessoaController.deletarPessoa(p.getId());
    assertNotNull(l);
  ...
  public void alterarPassageiro() {
    ...
    try {
      id =
          PassageiroController.cadastrarPassageiro("test", "test", "test", "test", "test", "test",
              date, null);
      PassageiroController.alterarPassageiro(id, "asdf", "asdf", "asdf", "asdf", "asdf", "asdf",
          date, null);
    } catch (Exception e) {
      fail();
    } finally {
