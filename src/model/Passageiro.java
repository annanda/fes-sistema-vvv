...
public class Passageiro extends Pessoa {
    ...
    // CONSTRUCTOR
    public Passageiro(String nome, String endereco, String codigo, String cpf, String telefone,
            String profissao, Date data_de_nascimento, Passageiro responsavel) {
    ...
    public Passageiro(int id_passageiro, int id_pessoa, String nome, String endereco,
            String codigo, String cpf, String telefone, String profissao, Date data_de_nascimento,
    ...
    public HashMap<String, String> toHashMap() {
        ...
        passageiro.put("id_passageiro_responsavel",
                (responsavel == null) ? null : Integer.toString(responsavel.getId()));
        passageiro.put("telefone", this.telefone);
