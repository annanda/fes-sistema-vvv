...
public class Persurso {
	 ...
	 * Constructor Pattern
	 */
	public Persurso(Date hora_partida, int horas_duracao_viagem, int codigo_aeroporto) {
	 ...
	 */
	public Persurso(String hora_partida, String horas_duracao_viagem,
