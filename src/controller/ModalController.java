...
public class ModalController {
  public static int cadastrarModal(String[] codigos_percursos, String tipo, String codigo,
    ...
    try {
      Modal novo_modal =
          new Modal(null, tipo, codigo, companhia, Integer.parseInt(capacidade), modelo,
              Integer.parseInt(ano_fabricacao), Integer.parseInt(em_manutencao),
              Integer.parseInt(em_uso), Constants.DATETIME_FORMAT.parse(data_manutencao));
      id = modal_dao.cadastrarModal(novo_modal);
      for (String codigo_percurso : codigos_percursos) {
        Percurso temp_percurso_modificado = PercursoController.getPercursoByCodigo(codigo_percurso);
  ...
  public static void alterarModal(int id_modal, String[] codigos_percursos, String tipo,
      String codigo, String companhia, String capacidade, String modelo, String ano_fabricacao,
      String em_manutencao, String em_uso, String data_manutencao) {
    ModalDAO modal_dao = new ModalDAO();

    try {
      Modal modal_modificado =
          new Modal(id_modal, null, tipo, codigo, companhia, Integer.parseInt(capacidade), modelo,
              Integer.parseInt(ano_fabricacao), Integer.parseInt(em_manutencao),
              Integer.parseInt(em_uso), Constants.DATETIME_FORMAT.parse(data_manutencao));
