...
public class CidadeController {
  ...
  public static void alterarCidade(int id_cidade, String novo_nome, String novo_identificador,
      String novo_codigo) {
    CidadeDAO cidade_dao = new CidadeDAO();

    Cidade cidade_modificada = new Cidade(id_cidade, novo_nome, novo_identificador, novo_codigo);
