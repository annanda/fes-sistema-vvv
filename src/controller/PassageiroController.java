...
public class PassageiroController {
	public static int cadastrarPassageiro(String nome, String endereco,
	...
	public static ArrayList<Passageiro> listarPassageiros(String nome_consultado,
			...
			String data_de_nascimento_consultado) {
	...
	public static void alterarPassageiro(int id_passageiro, String nome,
			String endereco, String codigo, String cpf, String telefone,
			String profissao, String data_de_nascimento, String responsavel) {
		PassageiroDAO passageiro_dao = new PassageiroDAO();
		...
		Passageiro passageiro_modificado = new Passageiro(nome, endereco, codigo,
